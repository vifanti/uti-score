...
const SAPS3Questionary: React.FC = () => {
  ...
  useEffect(() => {
    setQuestions(fakeApi.getFakeQuestions('PRISM II'));
  }, []);
  ...
  useEffect(() => {
    if (patient?.scoreData) {
      setScoreData(patient.scoreData.find(s => s.scoreType === 'PRISM II'));
    }
  }, [patient?.scoreData]);
  ...
  const handleCalcScore = useCallback(() => {
    if (patient) {
      fakeApi.setAnswers(patient.id, 'PRISM II', formData);
            ...
            <PatientAvatarInfo>
              ...
              <PatientInfo>
                ...
                {scoreData ? (
                  ...
                  <PatientMetaText>PRISM II não calculado</PatientMetaText>
                )}
              </PatientInfo>
            </PatientAvatarInfo>
          </PatientContainer>
