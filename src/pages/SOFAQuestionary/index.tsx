...
const SAPS3Questionary: React.FC = () => {
  ...
  useEffect(() => {
    setQuestions(fakeApi.getFakeQuestions('SOFA'));
  }, []);
  ...
  useEffect(() => {
    if (patient?.scoreData) {
      setScoreData(patient.scoreData.find(s => s.scoreType === 'SOFA'));
    }
  }, [patient?.scoreData]);
  ...
  const handleCalcScore = useCallback(() => {
    if (patient) {
      fakeApi.setAnswers(patient.id, 'SOFA', formData);
            ...
            <PatientAvatarInfo>
              ...
              <PatientInfo>
                ...
                {scoreData ? (
                  ...
                  <PatientMetaText>SOFA não calculado</PatientMetaText>
                )}
              </PatientInfo>
            </PatientAvatarInfo>
          </PatientContainer>
