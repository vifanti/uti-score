...
const SAPS3Questionary: React.FC = () => {
  ...
  useEffect(() => {
    setQuestions(fakeApi.getFakeQuestions('PSI'));
  }, []);
  ...
  useEffect(() => {
    if (patient?.scoreData) {
      setScoreData(patient.scoreData.find(s => s.scoreType === 'PSI'));
    }
  }, [patient?.scoreData]);
  ...
  const handleCalcScore = useCallback(() => {
    if (patient) {
      fakeApi.setAnswers(patient.id, 'PSI', formData);
            ...
            <PatientAvatarInfo>
              ...
              <PatientInfo>
                ...
                {scoreData ? (
                  ...
                  <PatientMetaText>PSI não calculado</PatientMetaText>
                )}
              </PatientInfo>
            </PatientAvatarInfo>
          </PatientContainer>
