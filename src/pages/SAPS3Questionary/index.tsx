...
const SAPS3Questionary: React.FC = () => {
  ...
  useEffect(() => {
    setQuestions(fakeApi.getFakeQuestions('SAPS-3'));
  }, []);
  ...
  useEffect(() => {
    if (patient?.scoreData) {
      setScoreData(patient.scoreData.find(s => s.scoreType === 'SAPS-3'));
    }
  }, [patient?.scoreData]);
  ...
  const handleCalcScore = useCallback(() => {
    if (patient) {
      fakeApi.setAnswers(patient.id, 'SAPS-3', formData);
            ...
            <PatientAvatarInfo>
              ...
              <PatientInfo>
                ...
                {scoreData ? (
                  ...
                  <PatientMetaText>SAPS-3 não calculado</PatientMetaText>
                )}
              </PatientInfo>
            </PatientAvatarInfo>
          </PatientContainer>
